...
%Podemos aplicar este metodo solo si a A se la puede expresar como A=LU
%siendo L matriz triang superior y U matriz triang inferior
%primero aplico la factorizacion LU ==> [L U P]=lu(A)
...
%Si la eliminacion Gaussiana para resolver el SEL Ax = b pueda
%llevarse a cabo hasta el final sin intercambio de filas entonces es
%posible realizar la factorizacion LU

%Es  util porque una vez hallada la factorizacion LU podemos resolver el
%SEL para distintos vectores b
