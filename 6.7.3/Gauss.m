...
Aum = [A b];
%dado el SEL Ax = b queremos construir un sistema equivalente Ux = c donde U matriz triangular superior

for q=1:n-1 %hago variar el q de 1 a n-1, recorro columna por columna, son los n-1 pasos de la eliminacion Gaussiana
    
% Pivoteo parcial con escalonamiento: para evitar la propagacion de errores
% de redondeo, para evitar aun mas se utiliza el pivoteo parcial escalonado
...
%mientras menor es la norma, menor es la cota de error del calculo del SEL
